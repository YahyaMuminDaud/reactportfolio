    ...
    return (
        <>
            ...
            <form method="POST">
                ...
                <textarea className="Answer2" name="message" placeholder="Enter Answer" value={user.message} autoComplete="off" required onChange={data}></textarea>
                <button id="button" className="submission" onClick={getData}>Submit</button>
                <button id="button" className="submission2" onClick={getData}>Submit</button>
